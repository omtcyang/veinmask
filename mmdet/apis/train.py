...
from mmdet.core import (CocoDistEvalmAPHook, CocoDistEvalRecallHook, DistEvalmAPHook, DistOptimizerHook, Fp16OptimizerHook, NonDistEvalmAPHook)
    ...
    if validate:
        ...
        if isinstance(model.module, RPN):
            ...
            if issubclass(dataset_type, datasets.CocoDataset):
                ...
                runner.register_hook(DistEvalmAPHook(val_dataset_cfg, interval=1, **eval_cfg))
...
def _non_dist_train(model, dataset, cfg, validate=False, logger=None):
    ...
    if validate:
        val_dataset_cfg = cfg.data.val
        eval_cfg = cfg.get('evaluation', {})
        runner.register_hook(NonDistEvalmAPHook(val_dataset_cfg, interval=1, **eval_cfg))
