...
from mmdet.core import (CocoDistEvalmAPHook, CocoDistEvalRecallHook,NonDistEvalmAPHook,
    ...
    if validate:
        ...
        if isinstance(model.module, RPN):
            ...
            if issubclass(dataset_type, datasets.CocoDataset):
                ...
                runner.register_hook(DistEvalmAPHook(val_dataset_cfg, interval=4, **eval_cfg))
