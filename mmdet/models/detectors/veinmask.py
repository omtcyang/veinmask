from ..Fusion.SCCSFusion import SSEFusion
...
class VeinMask(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(VeinMask, self).__init__(backbone, neck, bbox_head, train_cfg, test_cfg, pretrained)
    ...
    def forward_train(self,
        ...
        if _gt_labels is not None:
            extra_data = dict(_gt_labels=_gt_labels,
                              _sample_point=_sample_point,
                              _gt_bboxes=_gt_bboxes,
                              _gt_masks=_gt_masks,
                              centroidness=centroidness)
        else:
            extra_data = None
